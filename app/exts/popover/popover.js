...
var position = require('app/exts/dialog/position')
var template = require('app/exts/popover/popover.tpl')

require('css!app/exts/popover/popover.css')

module.exports = Brick.extend({
  options: {
